        ...
        <div className='card flex gap-x-[132px] border-b-2  py-[40px]'>
            ...
            <div className="flex flex-col justify-between">
                ...
                <div>
                    ...
                    <p className="font-['PoppinsRegular'] text-[16px] text-[#2e2525] flex">{description} <span className="bg-[#E6E6E6] w-[56px] h-[44px] flex items-center justify-center rounded-[8px]"><a href={link}><img src={arrow} alt="arrow"/></a></span></p>
                </div>
            </div>
        </div>
    );
